...
## Purpose
The workflow engine runs as a TypeScript surface of the `agentic-coding` binary, preserving the agent-facing CLI contract, drawn into clear module boundaries, with terminal-layout data kept out of persisted workflow state.
