...
## Purpose
Provides an interactive, persistent research workflow for user-directed knowledge gathering, optionally grounded in a read-only repository and optionally captured as a centralized wiki draft.
