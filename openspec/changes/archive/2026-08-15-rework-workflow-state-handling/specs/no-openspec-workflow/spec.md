...
**Reason**: No-OpenSpec workflow has no archive work; launching archive agent adds failure surface without evidence.
**Migration**: Pinned no-OpenSpec graph links developer approval directly to delivery.
