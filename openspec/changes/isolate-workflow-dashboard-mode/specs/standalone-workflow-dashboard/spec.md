...
Dash SHALL retain panel focus/scroll/selection, inline status and agent metrics, contextual help, explicit exit and dialogs necessary for workflow review, questions, credentials, approvals, confirmations and supported revision-bound actions. It SHALL NOT expose unrelated trace/detail pages, generic artifact browsing or persistent configuration editors through keyboard or mouse. Required review content SHALL remain available within its operational dialog.
