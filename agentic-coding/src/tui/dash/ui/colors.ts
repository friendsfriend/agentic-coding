...
const theme = (key: string, fallbackKey: string = "text") =>
	themeColor(
		key,
		fallbackKey === "text" ? rootText() : themeColor(fallbackKey, rootText()),
	);
...
export const uiColors = {
	...
	get selectionText() {
		return theme("selectedListItemText", "text");
	},
	...
	get diffAddedBg() {
		return theme("diffAddedBg", "backgroundPanel");
	},
	get diffRemovedBg() {
		return theme("diffRemovedBg", "backgroundPanel");
	},
	get diffContextBg() {
		return theme("diffContextBg", "backgroundPanel");
	},
} as const;
...
export const SCROLLBAR_OPTIONS = {
	...
	trackOptions: {
		...
		get foregroundColor() {
			return uiColors.scrollbarThumb;
		},
	},
} as const;
