...
import { SCROLLBAR_OPTIONS } from "../theme/colors";
...
export interface ScrollableContentProps {
	...
	/** Whether the scroll box participates in focus traversal. */
	focusable?: boolean;
...
export function allowsKeyboardAxis(
	props: Pick<ScrollableContentProps, "keyboardAxes">,
	axis: ScrollAxis,
) {
