...
export interface GenericModalProps {
	...
	/** Default true: a click inside the dialog never reaches the backdrop close
	 * handler. Only a surface that wants click-through opts out. */
				...
				>
					<box
						...
						onMouseUp={(e) => {
							...
							if (props.stopDialogClick ?? true) e.stopPropagation();
						}}
						width={width()}
						height={height()}
						flexDirection="column"
