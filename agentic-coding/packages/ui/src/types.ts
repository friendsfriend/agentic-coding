// Structural props for the framework's views (establish-opencode-boundaries,
// tasks 7.1-7.2).
//
// These are the shapes the views render — providers, applications, change
// requests, issues, jobs, clusters, runtimes. They are owned by this package so
// presentation never depends on an application or domain package: the
// application maps its records onto them at the TUI boundary (identity today,
// because the wire shapes already match).
