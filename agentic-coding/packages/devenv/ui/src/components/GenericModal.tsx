...
import type { GenericModalProps } from "../../../../../src/tui/shared/GenericModal";
import { GenericModal as SharedGenericModal } from "../../../../../src/tui/shared/GenericModal";

export type { GenericModalProps } from "../../../../../src/tui/shared/GenericModal";
export type { HelpEntry } from "../../../../../src/tui/shared/HelpText";
export type {
	Keybind,
	KeybindSection,
