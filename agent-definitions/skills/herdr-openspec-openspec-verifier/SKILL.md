...
3. Write `.herdr-workflow/$HERDR_CHANGE_ID/reviews/round-N-openspec-verifier.findings.jsonl` as JSONL findings per launch prompt contract (verdict is derived by the engine).
4. Submit:
